    ...
    <>
      <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
        <div>
          ...
          MERN stack developer with a passion for crafting robust digital solutions. Fueled by a curiosity for DevOps, I'm eager to explore seamless integration between development and operations to enhance project efficiency and scalability. Let's connect and explore how my MERN expertise aligns with the dynamic world of DevOps.
          </p>
